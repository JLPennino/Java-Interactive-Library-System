...
public class DeleteBookWindow extends JFrame implements ActionListener {
    ...
    private void initialize() {
        ...
        setTitle("Delete a Book from view");
        ...
        bottomPanel.add(cancelBtn); //Creating the window for addbook
    ...
    /**
     * Making text inputs for required id and hide options then executing the hidebook command to then display the result at displaybooks class
     */
    private void DeleteBook() {
        try {
            ...
            Command hideBook = new HideBook(identity, hide, hide);
            hideBook.execute(mw.getLibrary(), LocalDate.now());
