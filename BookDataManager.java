...
public class BookDataManager implements DataManager {
    ...
    private final String RESOURCE = "./resources/data/books.txt"; //Links to books.txt file through filepath
        ...
        try (Scanner sc = new Scanner(new File(RESOURCE))) {
            ...
            while (sc.hasNextLine()) {
                ...
                try {
                    ...
                    library.addBook(book); //The format to load the book details to the memory of library system
