...
public interface Command { //Displays the help menu
    ...
    public static final String HELP_MESSAGE = "Commands:\n"
            ...
            + "\tremovebook                      remove a book from view\n"
            + "\tremovepatron                    remove a patron from view\n"
    ...
    //executes upon inputting "help" in the library system
}
